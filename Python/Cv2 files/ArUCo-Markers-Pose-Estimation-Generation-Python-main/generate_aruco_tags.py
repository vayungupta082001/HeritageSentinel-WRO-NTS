...
tag = cv2.aruco.generateImageMarker(arucoDict, args["id"], tag_size, tag, 1)
...
tag_name = os.path.join(
    args["output"],
    f'{args["type"]}_id_{args["id"]}.png'
)
print("Current working directory:", os.getcwd())
print("Saving to:", os.path.abspath(tag_name))
saved = cv2.imwrite(tag_name, tag)

if saved:
    print("Tag saved successfully:", tag_name)
else:
